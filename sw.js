...
const SHELL = [
  ...
  './js/locale/en-chat-settings.js',
  './js/locale/en-tradebook.js',
  './js/locale/en-periods.js',
  './js/locale/en-settings-data.js',
  './js/locale/en-settings-security.js',
  './js/locale/en-chain.js',
  './js/locale/en-household.js',
  './js/locale/en-settings-connection.js',
  ...
  './js/domain/ical.js',
  './js/domain/identifiers.js',
  './js/domain/import.js',
  './js/domain/imports.js',
  './js/domain/estate.js',
  './js/domain/evidence.js',
  './js/domain/explain.js',
  './js/domain/kyc.js',
  './js/domain/kycconflict.js',
  './js/domain/ledger.js',
  './js/domain/inbox.js',
  ...
  './js/domain/example.js',
  './js/domain/example-life.js',
  './js/domain/example-assets.js',
  './js/domain/example-records.js',
  './js/domain/health.js',
  './js/domain/tenancy.js',
  './js/domain/upkeep.js',
  './js/domain/wellbeing.js',
  './js/domain/tree.js',
  './js/domain/warranty.js',
  ...
  './js/modules/settings/activity.js',
  './js/modules/settings/connection.js',
  './js/modules/settings/data.js',
  './js/modules/settings/display.js',
  './js/modules/settings/household.js',
  './js/modules/settings/privacy.js',
  './js/modules/settings/security.js',
  './js/modules/vault.js',
  ...
  './js/modules/secondary.js',
  './js/modules/wellbeing.js',
  './js/modules/vehicles.js',
  './js/services/belongings.js',
  './js/services/chat.js',
  './js/services/safety.js',
  './js/services/health.js',
  './js/services/secondary.js',
  './js/services/travel.js',
