...
| `js/locale/en.js` | The authoritative catalogue. 707<!--live:localeKeys--> keys today |
...
- 707<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 707<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
