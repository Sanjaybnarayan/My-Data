...
| `js/locale/en.js` | The authoritative catalogue. 975<!--live:localeKeys--> keys today |
...
and the catalogue grows to 975<!--live:localeKeys--> keys.
...
- 975<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 975<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
