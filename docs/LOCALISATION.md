...
| `js/locale/en.js` | The authoritative catalogue. 379<!--live:localeKeys--> keys today |
...
- 379<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 379<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
