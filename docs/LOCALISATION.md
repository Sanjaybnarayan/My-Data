...
| `js/locale/en.js` | The authoritative catalogue. 710<!--live:localeKeys--> keys today |
...
**3,095<!--live:unroutedStrings--> English strings, across 154<!--live:unroutedFiles--> files.** That is the measured count from
...
- 710<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,095<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 710<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
