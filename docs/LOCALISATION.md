...
| `js/locale/en.js` | The authoritative catalogue. 339<!--live:localeKeys--> keys today |
...
- 339<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 339<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
