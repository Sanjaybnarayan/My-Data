...
| `js/locale/en.js` | The authoritative catalogue. 598<!--live:localeKeys--> keys today |
...
**3,476<!--live:unroutedStrings--> English strings, across 159<!--live:unroutedFiles--> files.** That is the measured count from
...
- 598<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,476<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 598<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
