...
**3,409<!--live:unroutedStrings--> English strings, across 145<!--live:unroutedFiles--> files.** That is the measured count from
...
and machine-translating 3,409<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
