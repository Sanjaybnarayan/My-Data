...
| `js/locale/en.js` | The authoritative catalogue. 968<!--live:localeKeys--> keys today |
...
and the catalogue grows to 968<!--live:localeKeys--> keys.
...
- 968<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 968<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
