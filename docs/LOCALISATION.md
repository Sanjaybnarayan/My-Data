...
| `js/locale/en.js` | The authoritative catalogue. 979<!--live:localeKeys--> keys today |
...
and the catalogue grows to 979<!--live:localeKeys--> keys.
...
- 979<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 979<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
