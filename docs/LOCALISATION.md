...
| `js/locale/en.js` | The authoritative catalogue. 602<!--live:localeKeys--> keys today |
...
**3,474<!--live:unroutedStrings--> English strings, across 158<!--live:unroutedFiles--> files.** That is the measured count from
...
- 602<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,474<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 602<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
