...
| `js/locale/en.js` | The authoritative catalogue. 594<!--live:localeKeys--> keys today |
...
**3,480<!--live:unroutedStrings--> English strings, across 159<!--live:unroutedFiles--> files.** That is the measured count from
...
- 594<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,480<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 594<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
