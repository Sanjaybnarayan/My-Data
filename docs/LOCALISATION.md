...
| `js/locale/en.js` | The authoritative catalogue. 143<!--live:localeKeys--> keys today |
...
- 143<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 143<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
