...
| `js/locale/en.js` | The authoritative catalogue. 969<!--live:localeKeys--> keys today |
...
and the catalogue grows to 969<!--live:localeKeys--> keys.
...
- 969<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 969<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
