...
| `js/locale/en.js` | The authoritative catalogue. 970<!--live:localeKeys--> keys today |
...
placeholder. The unrouted count falls from 3,024 to 3,001<!--live:unroutedStrings-->
and the catalogue grows to 970<!--live:localeKeys--> keys.
...
**3,001<!--live:unroutedStrings--> English strings, across 162<!--live:unroutedFiles--> files.** That is the measured count from
...
- 970<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,001<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 970<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
