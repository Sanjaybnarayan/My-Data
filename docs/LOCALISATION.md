...
**3,493<!--live:unroutedStrings--> English strings, across 157<!--live:unroutedFiles--> files.** That is the measured count from
...
and machine-translating 3,493<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
