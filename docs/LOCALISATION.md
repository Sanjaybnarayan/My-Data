...
| `js/locale/en.js` | The authoritative catalogue. 912<!--live:localeKeys--> keys today |
...
**3,033<!--live:unroutedStrings--> English strings, across 158<!--live:unroutedFiles--> files.** That is the measured count from
...
- 912<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 912<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
