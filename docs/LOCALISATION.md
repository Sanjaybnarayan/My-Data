...
| `js/locale/en.js` | The authoritative catalogue. 917<!--live:localeKeys--> keys today |
...
- 917<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,031<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 917<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
