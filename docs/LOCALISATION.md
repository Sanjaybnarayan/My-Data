...
| `js/locale/en.js` | The authoritative catalogue. 382<!--live:localeKeys--> keys today |
...
- 382<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 382<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
