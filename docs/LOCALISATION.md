...
| `js/locale/en.js` | The authoritative catalogue. 402<!--live:localeKeys--> keys today |
...
**3,501<!--live:unroutedStrings--> English strings, across 157<!--live:unroutedFiles--> files.** That is the measured count from
...
- 402<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,501<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 402<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
