...
| `js/locale/en.js` | The authoritative catalogue. 960<!--live:localeKeys--> keys today |
...
placeholder. The unrouted count falls from 3,024 to 3,012<!--live:unroutedStrings-->
and the catalogue grows to 960<!--live:localeKeys--> keys.
...
**3,012<!--live:unroutedStrings--> English strings, across 162<!--live:unroutedFiles--> files.** That is the measured count from
...
- 960<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
and machine-translating 3,012<!--live:unroutedStrings--> strings of Indian financial and legal vocabulary
...
1. `js/locale/en.js` — 960<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
