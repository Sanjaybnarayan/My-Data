...
| `js/locale/en.js` | The authoritative catalogue. 709<!--live:localeKeys--> keys today |
...
- 709<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 709<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
