...
| `js/locale/en.js` | The authoritative catalogue. 655<!--live:localeKeys--> keys today |
...
- 655<!--live:localeKeys--> UI message keys — dates, the generic record screens, the language card
...
1. `js/locale/en.js` — 655<!--live:localeKeys--> strings, whole sentences, with `{placeholders}`
