...
| **Modules** | Nineteen<!--live:modules-->, over forty-three<!--live:entities--> entities. Nine are the same file reading the schema; the other ten have a screen of their own — dashboard, finance, investments, documents, family, calendar, identity, vault, reports and settings — as does the assistant, which is a route rather than a module |
