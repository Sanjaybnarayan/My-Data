...
| Chat device keypairs | End-to-end encryption between devices | Generated per device | `deviceKey` records | While the device is enrolled | The household | Public halves only | Private half wrapped like any field | With the device |
