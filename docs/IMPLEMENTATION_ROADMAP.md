...
| 10 | Insurance, vehicles, fuel, property, tenants, purchases, warranty, subscriptions, travel | **entities exist, intelligence mostly does not** — no fuel OCR, no warranty extraction. Rent *is* tracked, and a payment two lettings could claim is now attributed to neither rather than receipted twice (`docs/RENT_ATTRIBUTION.md`); **no tenant entity, no lease history, no arrears** |
