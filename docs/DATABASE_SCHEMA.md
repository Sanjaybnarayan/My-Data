...
- **53**<!--live:entities--> entities, **614**<!--live:fields--> fields, across **25**<!--live:modules--> modules
- **40**<!--live:encryptedFields--> fields encrypted — **6.5%**<!--live:encryptedPercent--> — the rest is plaintext locally and in the
  backup Sheet
