...
- **53**<!--live:entities--> entities, **617**<!--live:fields--> fields, across **25**<!--live:modules--> modules
- **45**<!--live:encryptedFields--> fields encrypted — **7.3%**<!--live:encryptedPercent--> — the rest is plaintext locally and in the
  backup Sheet
