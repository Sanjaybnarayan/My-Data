...
- **39**<!--live:entities--> entities, **479**<!--live:fields--> fields, across **19**<!--live:modules--> modules
- **34**<!--live:encryptedFields--> fields encrypted — **7.1%**<!--live:encryptedPercent--> — the rest is plaintext locally and in the
  backup Sheet
