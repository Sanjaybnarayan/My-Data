...
without leaving the screen you were comparing it against. Filter by account,
category, direction, date or amount, and every total is of the rows shown.
...
npm run test:browser  # 112 checks in a real Chromium
```
