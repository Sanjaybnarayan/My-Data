...
const person = {
  ...
  fields: [
    ...
    { key: 'emergencyContactPhone', type: 'phone', group: 'Emergency' },
...
const vehicle = {
  ...
  fields: [
    ...
    text('insurancePolicy', { group: 'Compliance' }),
    ...
    text('fastagId', { label: 'FASTag ID', group: 'Compliance' }),
...
const policy = {
  ...
  fields: [
    ...
    { key: 'agentPhone', type: 'phone', group: 'Contact' },
...
const property = {
  ...
  fields: [
    ...
    { key: 'tenantPhone', type: 'phone', group: 'Rental' },
    day('leaseEndsOn', { group: 'Rental', expiry: true, expiryLead: 60 }),
    money('deposit', { group: 'Rental' }),
    text('surveyNumber', { group: 'Records' }),
    text('khataNumber', { group: 'Records' }),
