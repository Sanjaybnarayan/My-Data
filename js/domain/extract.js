...
// The redaction catalogue and its matcher, moved out by the same ratchet.
// `readDocument` below is the only caller that needs both halves at once:
// what the document says, and what must not be kept of it.
import { readIdentifiers, redact } from './extract-sensitive.js';
