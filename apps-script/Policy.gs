...
var POLICY = {
  ...
  "conversation": { read: ["owner","spouse","adult","child"], write: ["owner","spouse","adult","child"] },
  "deviceKey": { read: ["owner","spouse","adult","child"], write: ["owner","spouse","adult","child"] },
  ...
  "locationPing": { read: ["owner","spouse","adult"], write: ["owner","spouse","adult","child"] },
  "medication": { read: ["owner","spouse","adult"], write: ["owner","spouse","adult"] },
  "message": { read: ["owner","spouse","adult","child"], write: ["owner","spouse","adult","child"] },
  ...
  "safeZone": { read: ["owner","spouse","adult","child"], write: ["owner","spouse","adult"] },
  "smsMessage": { read: ["owner","spouse","adult"], write: ["owner","spouse"] },
  "sosAlert": { read: ["owner","spouse","adult","child"], write: ["owner","spouse","adult","child"] },
